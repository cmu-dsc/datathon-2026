...
This folder contains the data relevant to the Smart Beneficiary Targeting Validation Challenge.

Analyze the relationship between project budgets and population indicators to identify statistical outliers in cost-per-beneficiary ratios, enabling the UN to benchmark project efficiency across different humanitarian clusters.

---

## Dataset Links:

Central Emergency Response Fund: https://data.humdata.org/organization/cerf
CBPF Allocations and Contributions: https://data.humdata.org/dataset/cbpf-allocations-and-contributions
